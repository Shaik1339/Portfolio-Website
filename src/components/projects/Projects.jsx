      ...
      <div className="section-blog">
        ...
        <div className="container grid grid-four--cols">
          <div className="blog">
            <figure>
              <Link
                to="https://shaik1339.github.io/Hotstarclone/"
                target="_blank"
              >
          ...
          <div className="blog">
            ...
            <div className="blog-content">
              ...
              <p className="blog-para">
                For music lovers it will heplful we can play Music with keyboard
                by pressing keys mentioned on drums.
              </p>
            </div>
          </div>
          ...
          <div className="blog">
            ...
            <div className="blog-content">
              ...
              <p className="blog-para">
                Here you can learn latest trending Technologies and Courses
                efficiently,at anytime and anywhere.
              </p>
            </div>
          </div>
          ...
          <div className="blog">
            ...
            <div className="blog-content">
              ...
              <p className="blog-para">
                This is Personal Portfolio website , where you can find My
                Projects , skills and Contact details you can reach me at
                anytime for any Query.
              </p>
            </div>
          </div>
          ...
          <div className="blog">
            <figure>
              <Link
                to="https://shaik1339.github.io/Dicegame.github-io/ "
                target="_blank"
              >
